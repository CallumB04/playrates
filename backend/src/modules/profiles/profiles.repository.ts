...
/**
 * The repository interface is the seam that makes route tests fast: swap in an
 * in-memory implementation and the entire HTTP stack — real middleware, real
 * zod, real error handler — runs with no database.
 */
