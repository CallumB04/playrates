...
import { toExternalGame, type RawgGame } from "../../src/providers/games/rawg/rawg.mapper.js";
...
describe("RAWG mapper", () => {
    it("maps the core fields", () => {
        ...
        expect(game.coverUrl).toBe(
            "https://media.rawg.io/media/games/witcher.jpg"
        );
    });
    ...
    it("treats other ratings, and no rating, as not adult", () => {
        ...
        expect(
            toExternalGame({ ...rawgResponse, esrb_rating: null }).isAdult
        ).toBe(false);
    });
